...
describe('Function argument type', () => {
  it.each([
    ...
    ['function a(arg = 5) {}', {"type":"Program","start":0,"end":22,"body":[{"type":"FunctionDeclaration","start":0,"end":22,"id":{"type":"Identifier","start":9,"end":10,"name":"a"},"expression":false,"generator":false,"async":false,"params":[{"type":"AssignmentPattern","start":11,"end":18,"left":{"type":"Identifier","start":11,"end":14,"name":"arg"},"right":{"type":"Literal","start":17,"end":18,"value":5,"raw":"5"}}],"body":{"type":"BlockStatement","start":20,"end":22,"body":[]}}],"sourceType":"module"}],
